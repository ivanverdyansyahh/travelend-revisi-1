                ...
                <div class="col-12 col-md-10 col-lg-8 col-xl-6">
                    ...
                    <form action="/destinations">
                        <div class="input-group mb-3">
                            ...
                            <input type="text" name="search" class="form-control" placeholder="Searching destination.."
                    ...
                    @foreach ($destinations as $item)
                        <div class="col-12 col-md-6 col-lg-4 col-xl-3 mb-4">
                            <div class="card-destination rounded overflow-hidden">
                                <a href="/destination/{{ $item->category->slug }}/{{ $item->slug }}">
                                    ...
                                    @else
                                        <img src="https://picsum.photos/301" class="img-fluid w-100" alt="Image Example">
                                    @endif
                                </a>
